...
class Status Publisher (Node):
	def__init__(self):
		super().__init__('status_publisher') 
		self.init_status() 
		self.publisher_ = self.create_publisher(Bool. 'status_topic', 10) period = 1
	...
	def init_status(self):
		self.pi = pigpio.pi() 
		self.pi.set_mode (STATUS_PIN, pigpio.INPUT) self.pi.set_pull_up_down (STATUS_PIN, pigpio.PUD_UP)
